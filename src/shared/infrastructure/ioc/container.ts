...
import { Sha256HashService } from "@shared-infrastructure/hash/sha256-hash.service";
...
container.bind<IHashService>(TYPES.HashService).to(Sha256HashService);
...
// Modules
void container.load(usersModule, systemModule, rolesModule, authModule);
